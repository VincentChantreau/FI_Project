...
public class StringOperation {
	 ...
	 * @param mode
	 *            Mode de transformation, plusieurs mode sont accessibles, ceux-ci
	 *            peuvent être combiné - LOWER_CASE : Mise en minuscule - UPPER_CASE
	 *            : Mise en majuscule - WITHOUT_ACCENTS : Remplace les caractères
	 *            accentués par leur version sans accent La combinaision de mode se
	 *            fait de la sorte LOWER_CASE | WITHOUT_ACCENTS
	 ...
	 * @return index du 1er caractère à transformer, -1 si aucun caractère n'est a
	 *         transformer
	 */
	private static int scan(java.lang.String chaine, int mode) {
		/**
		 * ALPHA_NUM WITHOUT_SPECIALS_CHARS LOWER_CASE UPPER_CASE WITHOUT_ACCENTS
		 */
		int computedMode = 0;
